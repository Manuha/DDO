...
def ODESYS(Y,t,theta):
    ...
    # print(J(Y[:2],t,theta)@Y[-2::], grad_f_theta(Y[:2],t,theta))
...
# print("random")
# print(np.random.normal(0,0.05,size = sol[:,:2].shape))
# print("add")
print(sol[1,:2]+ [0.01693986, -0.06596811])
